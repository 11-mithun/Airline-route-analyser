...
const Footer: React.FC = () => {
  return (
    <footer className="bg-midnight-dark py-8 border-t border-gray-800">
      <div className="container mx-auto px-6">
        ...
        >
          <div className="mb-6 md:mb-0">
            <h2 className="text-2xl font-bold text-forest">Airline Route Analyzer</h2>
            <p className="text-sm text-gray-400 mt-1">Powered by advanced ML and 3D visualization</p>
          </div>
